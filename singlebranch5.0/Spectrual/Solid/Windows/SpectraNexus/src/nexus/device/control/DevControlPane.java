...
public class DevControlPane extends javax.swing.JPanel {
    ...
    private void InitDevInfo() {
        ...
        this.Button_DarkModify.setVisible(false);
        this.Button_LightEnable.setVisible(false);
    }
    ...
    private void InitDevControl() {
        ...
        this.devcontrol.RegisterStateChange(new EventListener<CSTATE>() {
            ...
            public void recevieEvent(Event<CSTATE> event) {
                ...
                if (event.GetEvent() == CSTATE.CONNECT && (CSTATE) event.Info() == CSTATE.CLOSE) {
                    //初始控制设备信息
...
//        this.Button_AutoTestTime.setEnabled(state == CSTATE.CONNECT);
        ...
        this.Button_StopCollect.setEnabled(state == CSTATE.BUSSY && SoildSystem.GetInstance().GetSoilControl().IsStartCollect());
        this.Button_LightEnable.setEnabled(state == CSTATE.CONNECT);
        this.Button_CalSwitch.setEnabled(state == CSTATE.CONNECT);
...
//        }
    ...
    private void initComponents() {
        ...
        Button_CalSwitch = new javax.swing.JToggleButton();
        ...
        Button_CalSwitch.setText("定标");
        Button_CalSwitch.setEnabled(false);
        Button_CalSwitch.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Button_CalSwitchActionPerformed(evt);
            }
        });
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(5, 5, 5)
                        .addComponent(Button_CalSwitch, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );

        jPanel2Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {Button_CalSwitch, Button_DarkModify, Button_FrequenCollect, Button_LightEnable, Button_SetParameter, Button_SingelCollect, Button_StopCollect});
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(Button_CalSwitch, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(5, 5, 5)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(Button_DarkModify))
                .addGap(5, 5, 5))
        );

        jPanel2Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {Button_CalSwitch, Button_DarkModify, Button_FrequenCollect, Button_LightEnable, Button_SetParameter, Button_SingelCollect, Button_StopCollect});
    ...
    private void Button_StopCollectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Button_StopCollectActionPerformed
        //停止连续采集
        SoildSystem.GetInstance().GetSoilControl().StopCollectData();
    ...
    private void Button_SingelCollectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Button_SingelCollectActionPerformed
        try {
            //如果设备不忙，开始采集
            SoildSystem.GetInstance().GetSoilControl().StartSingleTest(
                    new SSDataCollectPar(this.GetIntegertime(), this.GetAverageTime(), this.GetCollectMode()),
    ...
    private void Button_FrequenCollectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Button_FrequenCollectActionPerformed
        try {
            //如果设备不忙，开始采集
            SoildSystem.GetInstance().GetSoilControl().StartSustainCollect(
                    new SSDataCollectPar(this.GetIntegertime(), this.GetAverageTime(), this.GetCollectMode()),
                    this.GetSmoothWindow(),
    ...
    private void Button_SetParameterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Button_SetParameterActionPerformed
        ...
        if (lcontrol != null) {
            try {
                ...
                if (Button_LightEnable.isSelected()) {
    ...
    private void Button_DarkModifyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Button_DarkModifyActionPerformed
        try {
            ...
            Button_DarkModify.setSelected((devcontrol.GetDataCollecor().IsDKEnable()));
        } catch (Exception ex) {
            FaultCenter.Instance().SendFaultReport(Level.SEVERE, ex.getMessage());
        }
    ...
    private void Button_LightEnableActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Button_LightEnableActionPerformed
        ...
        if (lcontrol != null) {
            try {
                ...
                if (Button_LightEnable.isSelected() != devcontrol.GetLightControl().IsLightEnable()) {
                    Button_LightEnable.setSelected(!Button_LightEnable.isSelected());
                    FaultCenter.Instance().SendFaultReport(Level.SEVERE, "光源打开失败");
                }
                if (Button_LightEnable.isSelected()) {
                    Button_LightEnable.setIcon(new javax.swing.ImageIcon(
                            getClass().getResource("/nexus/device/resources/light_on.png")));
    ...
    private void Button_CalSwitchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Button_CalSwitchActionPerformed
        if(Button_CalSwitch.isSelected()){
            SoildSystem.GetInstance().GetSoilControl().SwitchState(CollectControl.SAppState.Cal);
        }else{
            SoildSystem.GetInstance().GetSoilControl().SwitchState(CollectControl.SAppState.Test);
        }
    }//GEN-LAST:event_Button_CalSwitchActionPerformed


    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JTextField Average_Input;
    private javax.swing.JToggleButton Button_CalSwitch;
