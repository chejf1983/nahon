...
import app.common.chartmath.InitPaneHelper;
...
public class CharTestFrame extends javax.swing.JFrame {
    ...
    private SpectralChartPane spectralChartPane2 = new SpectralChartPane();
...
//        id++;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        this.spectralChartPane2.DisplaySPData("testmain", new SPData(index, data));
            ...
            Executors.newSingleThreadExecutor().submit(new Runnable() {
                ...
                public void run() {
                    while (jToggleButton1.isSelected()) {
                        ...
                        spectralChartPane2.DisplaySPData("testmain", new SPData(index, data));
                        try {
...
//        new ConfigureDialog(this, true).setVisible(true);
    ...
    ArrayList<SPData> spdata = new ArrayList();
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        spdata.add(new SPData(index, data));
        String name[] = new String[spdata.size()];
        for (int i = 0; i < name.length; i++) {
            name[i] = "HS-" + i;
        }
        this.spectralChartPane2.DisplaySnapShot(name, spdata.toArray(new SPData[0]));
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        try {
            File file = InitPaneHelper.GetFilePath(".png");
            if (file != null) {
