...
import AppCommon.SPDataChart.ZoomUpHelper.ZoomState;
...
public class ChartRangePaint {
    ...
    //修改chart范围类型
    void ChangeType(RangeType type) {
        this.rangetype = type;
...
//        if (this.parent.snapshot != null) {
//            for (int i = 0; i < this.parent.snapshot.length; i++) {
//                if (MaxNodeValue < this.parent.snapshot[i].getMaxY()) {
//                    MaxNodeValue = this.parent.snapshot[i].getMaxY();
//                }
//            }
//        }
