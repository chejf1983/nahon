...
import sps.app.reflect.SRefData;
 ...
 * @author jiche
 */
public class ReflectAppUI extends javax.swing.JPanel {
    ...
    private RefChartTable aRateCTPane = new RefChartTable();
    ...
    private void InitTableAndChart() {
        ...
        LanguageHelper.getIntance().EventCenter.RegeditListener(new EventListener() {
            ...
            public void recevieEvent(Event event) {
                ...
                ChartTable_TabbedPane.setTitleAt(1, LanguageHelper.getIntance().GetText("RefPane_Name"));
            }
        });
    }
    // </editor-fold>
    ...
    private ReflectApp abs_app;

    private void InitDataAnalyzer() {
        this.abs_app = SpectralPlatService.GetInstance().GetAppManager().GetReflectApp();
        /* Register to DataSource */
        this.abs_app.RegisterDataCollectListener(new EventListener<SRefData>() {
            @Override
            public void recevieEvent(final Event<SRefData> event) {
...
//                });
    ...
    private void DisplayData(SRefData data) {
        /* display main data */
...
// </editor-fold>
    ...
    private void Button_SaveImageActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Button_SaveImageActionPerformed
        try {
            ...
            Logger.getLogger(ReflectAppUI.class.getName()).log(Level.SEVERE, null, ex);
        }
